...
<div class="min-h-screen flex items-center justify-center">
    <div class="w-full md:max-w-5xl bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-2xl font-bold flex items-center gap-2 mb-6">
            <i class="bi bi-plus-square-fill text-blue-600"></i> Tambah Kegiatan / Berita
        </h2>
        ...
        <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="text" name="reporter" value="{{ old('reporter') }}"
            ...
            <div class="mb-4">
                ...
                <textarea name="isi" rows="6"
                    class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400 @error('isi') border-red-500 @enderror" required>{{ old('isi') }}</textarea>
                @error('isi')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="number" name="pengunjung" value="{{ old('pengunjung', 0) }}"
            ...
            <div class="flex justify-end pt-4 gap-2">
                ...
                <button type="submit"
                    ...
                    <i class="bi bi-save-fill mr-1"></i> Simpan Berita
                </button>
            </div>
        </form>
    </div>
